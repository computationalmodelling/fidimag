...
#      /\ /\ /\ /\ /\ /\ /\ /\ /\
#     |  |  |  |  |  |  |  |  |  |
#     |45|46|47|48|49|50|51|51|52|
#      \ /\ /\ /\ /\ /\ /\ /\ /\ /\
#       |  |  |  |--|  |  |  |  |  |
#       |36|37|38|39|40|41|42|43|44|
#      /\ /\ /\ /\ /\ /\ /\ /\ /\
#     |  |  |--|xx|xx|--|  |  |  |          OO i-th site
#     |27|28|29|30|31|32|33|34|35|          xx 1st neighbours (nearest)
#      \ /\ /\ /\ /\ /\ /\ /\ /\ /\         -- 2nd neighbours
#       |  |  |xx|OO|xx|  |  |  |  |
...
def test_x_neighbours_multiple_square():
    ...
    """
    mesh = HexagonalMesh(1, 9, 6, alignment='square', shells=2)
    print(mesh.neighbours)
    assert (mesh.neighbours[21] == [22, 20, 31, 12, 30, 13,  # 1st shell
                                    32, 11, 39, 3, 29, 14,   # 2nd shell
                                    ]
            ).all()
