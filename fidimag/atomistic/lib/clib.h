...
void compute_exch_field(double *restrict spin, double *restrict field,
                        double *restrict mu_s_inv, double *restrict energy,
                        double Jx, double Jy, double Jz, int *restrict ngbs,
                        int n, int n_ngbs);

void compute_exch_field_spatial(double *restrict spin, double *restrict field,
                                double *restrict mu_s_inv,
                                double *restrict energy, double *restrict J,
                                int *restrict ngbs, int n, int n_ngbs);

double compute_exch_energy(double *restrict spin, double Jx, double Jy,
                           double Jz, int nx, int ny, int nz, int xperiodic,
                           int yperiodic);

void compute_full_exch_field(double *restrict spin, double *restrict field,
                             double *restrict mu_s_inv, double *restrict energy,
                             double J[9], int *restrict ngbs, int n, int n_ngbs,
...
void dmi_field_bulk(double *restrict spin, double *restrict field,
                    double *restrict mu_s_inv, double *restrict energy,
                    double *restrict D, int *restrict ngbs, int n, int n_ngbs);

void dmi_field_interfacial_atomistic(double *spin, double *field,
                                     double *mu_s_inv, double *energy,
                                     double *restrict D, int *ngbs, int n,
                                     int n_ngbs, int n_ngbs_dmi,
                                     double *DMI_vec);

double dmi_energy(double *restrict spin, double D, int nx, int ny, int nz,
                  int xperiodic, int yperiodic);

// ----------------------------------------------------------------------------
// From demag_full.c

void demag_full(double *restrict spin, double *restrict field,
                double *restrict energy, double *restrict coords,
...
void llg_rhs_dw_c(double *restrict m, double *restrict h, double *restrict dm,
                  double *restrict T, double *restrict alpha,
                  double *restrict mu_s_inv, int *pins, double *restrict eta,
                  int n, double gamma, double dt);

// ----------------------------------------------------------------------------
// From mc.c

void llg_s_rhs(double *restrict dm_dt, double *restrict spin,
               double *restrict h, double *restrict alpha, double *restrict chi,
               double gamma, int n);

void run_step_mc(mt19937_state *state, double *spin, double *new_spin,
                 int *ngbs, int *nngbs, int n_ngbs, double J, double J1,
                 double D, double D1, double *h, double Kc, int n, double T,
                 int hexagonal_mesh);
