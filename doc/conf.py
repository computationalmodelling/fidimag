...
latex_documents = [
  ('index', 'pccp.tex', u'pccp Documentation',
...
man_pages = [
    ('index', 'pccp', u'pccp Documentation',
     [u'Weiwei Wang'], 1)
]
...
texinfo_documents = [
  ('index', 'pccp', u'pccp Documentation',
   u'Weiwei Wang', 'pccp', 'One line description of project.',
   'Miscellaneous'),
]
